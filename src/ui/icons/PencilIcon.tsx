...
import { SquareFilledIcon } from "@/ui/icons/SquareFilledIcon";
...
/**
 * PencilIcon component that renders a SquareFilledIcon inside a span.
 * Despite the name "PencilIcon" in the prompt, the minified code and tests
 * indicate it renders a square icon (SquareFilledIcon).
 */
